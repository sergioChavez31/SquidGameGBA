...
// a button is recently pressed if it wasn't pressed in the last
...
#define KEY_JUST_PRESSED(key, buttons, oldbuttons) (!((oldbuttons) & key) && KEY_DOWN(key, buttons) && ((oldbuttons) |= key))
